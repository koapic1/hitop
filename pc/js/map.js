...
const addressList = [
    { address: "서울 중구 세종대로 110", title: "서울 사무실", link: "http://www.daum.net" },
    { address: "서울특별시 영등포구 선유로 130", title: "강원도 사무실", link: "http://www.naver.com" },
    { address: "경기 과천시 대공원광장로 102", title: "제 1 공장", link: "http://www.google.com" },
];
...
locationTabMenu.on("click", function () {
    if ($(this).index() === 0) {
        loadMap({ address: "서울 중구 세종대로 110", title: "서울 사무실", link: "http://www.daum.net" });
    } else if ($(this).index() === 1) {
        loadMap({ address: "서울특별시 영등포구 선유로 130", title: "강원도 사무실", link: "http://www.naver.com" });
    } else if ($(this).index() === 2) {
        loadMap({ address: "경기 과천시 대공원광장로 102", title: "제 1 공장", link: "http://www.google.com" });
    }
});
*/
